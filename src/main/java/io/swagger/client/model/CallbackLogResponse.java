...
import io.swagger.client.model.CallbackLogEntry;
...
public class CallbackLogResponse {
  /**
  ...
  private List<CallbackLogEntry> results = null;

  public CallbackLogResponse success(SuccessEnum success) {
  ...
  **/
  ...
  public CallbackLogResponse error(Object error) {
    this.error = error;
    return this;
  }
  ...
  **/
  ...
  public CallbackLogResponse results(List<CallbackLogEntry> results) {
    this.results = results;
    return this;
  }

  public CallbackLogResponse addResultsItem(CallbackLogEntry resultsItem) {
    if (this.results == null) {
      this.results = new ArrayList<CallbackLogEntry>();
    }
   ...
   /**
   * Array of CallbackLogEntry objects.
   * @return results
  **/
  @ApiModelProperty(value = "Array of CallbackLogEntry objects.")
  public List<CallbackLogEntry> getResults() {
    return results;
  }

  public void setResults(List<CallbackLogEntry> results) {
    this.results = results;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    CallbackLogResponse callbackLogResponse = (CallbackLogResponse) o;
    return Objects.equals(this.success, callbackLogResponse.success) &&
        Objects.equals(this.error, callbackLogResponse.error) &&
        Objects.equals(this.results, callbackLogResponse.results);
  }
  ...
  public String toString() {
    ...
    sb.append("class CallbackLogResponse {\n");
