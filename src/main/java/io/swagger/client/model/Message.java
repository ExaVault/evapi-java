...
public class Message {
   ...
   * @return id
  **/
  @ApiModelProperty(example = "397584", value = "Message id.")
  ...
  public Message userId(Integer userId) {
   ...
   /**
   * ID of the user this message belogns to.
   * @return userId
  **/
  @ApiModelProperty(example = "192667", value = "ID of the user this message belogns to.")
  ...
  public Message shareId(String shareId) {
    this.shareId = shareId;
    return this;
  }

   /**
   * ID of the share this message belongs to.
   * @return shareId
  **/
  @ApiModelProperty(example = "645878", value = "ID of the share this message belongs to.")
   ...
   * @return subject
  **/
  @ApiModelProperty(example = "Files available for download", value = "Message subject.")
   ...
   * @return body
  **/
  @ApiModelProperty(example = "You have files available for download.", value = "Message text.")
   ...
   * @return created
  **/
  @ApiModelProperty(example = "2017-01-26 18:10:47", value = "Timestamp of message creation.")
  ...
  public Message modified(String modified) {
   ...
   * @return modified
  **/
  @ApiModelProperty(example = "2017-01-28 13:10:47", value = "Timestamp of message modification.")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.id, message.id) &&
        ...
        Objects.equals(this.shareId, message.shareId) &&
        ...
        Objects.equals(this.modified, message.modified);
  }
