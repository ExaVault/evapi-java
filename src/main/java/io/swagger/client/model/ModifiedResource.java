...
/**
 * Array of copied or moved resources.
 */
@ApiModel(description = "Array of copied or moved resources.")
...
public class ModifiedResource {
  ...
  /**
   * Flag indicates operation success status. &#x60;0&#x60; is failure; &#x60;1&#x60; is success.
   */
  ...
  public ModifiedResource file(String file) {
    this.file = file;
    return this;
  }
   ...
   * @return file
  **/
  @ApiModelProperty(value = "Path to the resource.")
  ...
  public ModifiedResource destination(String destination) {
    this.destination = destination;
    return this;
  }

   /**
   * Destinsation path of the operation.
   * @return destination
  **/
  @ApiModelProperty(value = "Destinsation path of the operation.")
  ...
  public ModifiedResource size(Long size) {
    this.size = size;
    return this;
  }
  ...
  **/
  ...
  public ModifiedResource success(SuccessEnum success) {
   ...
   * @return success
  **/
  @ApiModelProperty(value = "Flag indicates operation success status. `0` is failure; `1` is success.")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    ModifiedResource modifiedResource = (ModifiedResource) o;
    return Objects.equals(this.file, modifiedResource.file) &&
        Objects.equals(this.destination, modifiedResource.destination) &&
        Objects.equals(this.size, modifiedResource.size) &&
        Objects.equals(this.success, modifiedResource.success);
  }

  @Override
  public int hashCode() {
    return Objects.hash(file, destination, size, success);
  }
