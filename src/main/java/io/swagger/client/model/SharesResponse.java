...
public class SharesResponse {
  ...
  private List<Share> results = null;

  public SharesResponse success(SuccessEnum success) {
  ...
  **/
  ...
  public SharesResponse error(Object error) {
    this.error = error;
    return this;
  }
  ...
  **/
  ...
  public SharesResponse results(List<Share> results) {
    this.results = results;
    return this;
  }

  public SharesResponse addResultsItem(Share resultsItem) {
    if (this.results == null) {
      this.results = new ArrayList<Share>();
    }
   ...
   * @return results
  **/
  @ApiModelProperty(value = "Array of Share objects.")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.success, sharesResponse.success) &&
        Objects.equals(this.error, sharesResponse.error) &&
        Objects.equals(this.results, sharesResponse.results);
  }
