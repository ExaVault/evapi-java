...
public class MoveResources {
  ...
  public MoveResources accessToken(String accessToken) {
  ...
  **/
  ...
  public MoveResources filePaths(List<String> filePaths) {
    this.filePaths = filePaths;
    return this;
  }

  public MoveResources addFilePathsItem(String filePathsItem) {
   ...
   * @return filePaths
  **/
  @ApiModelProperty(example = "[\"/folder\",\"/file.jpg\",\"/nested/file.txt\"]", required = true, value = "Array containing file/folder paths to move.")
  ...
  public MoveResources destinationPath(String destinationPath) {
  ...
  **/
  @ApiModelProperty(example = "/", required = true, value = "Remote destination path to move files/folders to.")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    MoveResources moveResources = (MoveResources) o;
    return Objects.equals(this.accessToken, moveResources.accessToken) &&
        Objects.equals(this.filePaths, moveResources.filePaths) &&
        Objects.equals(this.destinationPath, moveResources.destinationPath);
  }
