...
public class CopyResources {
  ...
  public CopyResources accessToken(String accessToken) {
  ...
  **/
  ...
  public CopyResources filePaths(List<String> filePaths) {
    this.filePaths = filePaths;
    return this;
  }

  public CopyResources addFilePathsItem(String filePathsItem) {
    this.filePaths.add(filePathsItem);
    return this;
  }

   /**
   * Array containing file/folder paths to copy.
   * @return filePaths
  **/
  @ApiModelProperty(example = "[\"/folder\",\"/file.jpg\",\"/nested/file.txt\"]", required = true, value = "Array containing file/folder paths to copy.")
  ...
  public CopyResources destinationPath(String destinationPath) {
  ...
  **/
  @ApiModelProperty(example = "/folder/folder here", required = true, value = "Remote destination path to copy files/folders to.")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    CopyResources copyResources = (CopyResources) o;
    return Objects.equals(this.accessToken, copyResources.accessToken) &&
        Objects.equals(this.filePaths, copyResources.filePaths) &&
        Objects.equals(this.destinationPath, copyResources.destinationPath);
  }

  @Override
  public int hashCode() {
    return Objects.hash(accessToken, filePaths, destinationPath);
  }
