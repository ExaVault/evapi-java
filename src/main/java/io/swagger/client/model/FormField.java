...
import io.swagger.client.model.FormFieldSettings;
...
public class FormField {
   ...
   * @return id
  **/
  @ApiModelProperty(example = "1185", value = "Field id number")
   ...
   * @return name
  **/
  @ApiModelProperty(example = "Your Name", value = "Label of the field")
   ...
   * @return order
  **/
  @ApiModelProperty(example = "0", value = "Order that field appears on the form, starting from 0")
  ...
  public FormField type(Object type) {
    this.type = type;
    return this;
  }
