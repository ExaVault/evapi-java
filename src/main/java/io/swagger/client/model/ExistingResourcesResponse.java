...
import io.swagger.client.model.ExistingResource;
...
public class ExistingResourcesResponse {
  ...
  private List<ExistingResource> results = null;

  public ExistingResourcesResponse success(SuccessEnum success) {
  ...
  **/
  ...
  public ExistingResourcesResponse error(Object error) {
    this.error = error;
    return this;
  }
  ...
  **/
  ...
  public ExistingResourcesResponse results(List<ExistingResource> results) {
    this.results = results;
    return this;
  }

  public ExistingResourcesResponse addResultsItem(ExistingResource resultsItem) {
    if (this.results == null) {
      this.results = new ArrayList<ExistingResource>();
    }
   ...
   * @return results
  **/
  @ApiModelProperty(value = "Array of resources.")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    ExistingResourcesResponse existingResourcesResponse = (ExistingResourcesResponse) o;
    return Objects.equals(this.success, existingResourcesResponse.success) &&
        Objects.equals(this.error, existingResourcesResponse.error) &&
        Objects.equals(this.results, existingResourcesResponse.results);
  }
