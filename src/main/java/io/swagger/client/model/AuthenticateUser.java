...
public class AuthenticateUser {
  ...
  public AuthenticateUser username(String username) {
   ...
   * @return username
  **/
  @ApiModelProperty(example = "exavaultuser", required = true, value = "Name of the user to authenticate.")
  ...
  public AuthenticateUser password(String password) {
   ...
   * @return password
  **/
  @ApiModelProperty(example = "secretPassw0rd", required = true, value = "User's password.")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.username, authenticateUser.username) &&
        Objects.equals(this.password, authenticateUser.password);
  }
