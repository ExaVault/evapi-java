...
public class ExtractFilesResponse {
  ...
  private List<ResourceProperty> results = null;

  public ExtractFilesResponse success(SuccessEnum success) {
  ...
  **/
  ...
  public ExtractFilesResponse error(Object error) {
    this.error = error;
    return this;
  }

   /**
   * when success attribute is &#x60;0&#x60;, this will contain an explanatory message.
   * @return error
  **/
  @ApiModelProperty(example = "{}", value = "when success attribute is `0`, this will contain an explanatory message.")
  ...
  public ExtractFilesResponse results(List<ResourceProperty> results) {
    this.results = results;
    return this;
  }

  public ExtractFilesResponse addResultsItem(ResourceProperty resultsItem) {
    if (this.results == null) {
      this.results = new ArrayList<ResourceProperty>();
    }
   ...
   /**
   * Array of extracted resources.
   * @return results
  **/
  @ApiModelProperty(value = "Array of extracted resources.")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    ExtractFilesResponse extractFilesResponse = (ExtractFilesResponse) o;
    return Objects.equals(this.success, extractFilesResponse.success) &&
        Objects.equals(this.error, extractFilesResponse.error) &&
        Objects.equals(this.results, extractFilesResponse.results);
  }
  ...
  public String toString() {
    ...
    sb.append("class ExtractFilesResponse {\n");
