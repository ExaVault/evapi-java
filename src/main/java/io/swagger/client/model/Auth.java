...
/**
 * Object with authentication info.
 */
@ApiModel(description = "Object with authentication info.")
...
public class Auth {
   ...
   * @return username
  **/
  @ApiModelProperty(example = "exavaultuser", value = "Name of the authenticated user.")
   ...
   * @return accessToken
  **/
  @ApiModelProperty(example = "58d2899d284a491eaf2010cecbe401d0c71cd84", value = "Token to use for API calls.")
   ...
   * @return mode
  **/
  @ApiModelProperty(example = "0", value = "Authentication mode.")
  ...
  public Auth clientIp(String clientIp) {
   ...
   * @return clientIp
  **/
  @ApiModelProperty(example = "123.123.123.123", value = "IP address of the authenticated client.")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.username, auth.username) &&
        Objects.equals(this.accessToken, auth.accessToken) &&
        Objects.equals(this.mode, auth.mode) &&
        Objects.equals(this.clientIp, auth.clientIp);
  }

  @Override
  public int hashCode() {
    return Objects.hash(username, accessToken, mode, clientIp);
  }
