...
public class NotificationRecipient {
  ...
  **/
  ...
  public NotificationRecipient notificationId(String notificationId) {
  ...
  **/
  @ApiModelProperty(example = "23", value = "ID of the notification that the recipient belongs to.")
   ...
   * @return email
  **/
  @ApiModelProperty(example = "exampleuser@exavault.com", value = "Recipient email.")
  ...
  public NotificationRecipient created(String created) {
   ...
   * @return created
  **/
  @ApiModelProperty(example = "2017-04-21 10:53:47", value = "Timestamp of adding notification recipient.")
  ...
  public NotificationRecipient modified(String modified) {
   ...
   * @return modified
  **/
  @ApiModelProperty(example = "2017-05-10 13:17:56", value = "Timestamp of notification recipient modification.")
