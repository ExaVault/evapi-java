...
import io.swagger.client.model.FormFieldData;
 ...
 */
@ApiModel(description = "Object submissions data for form.")
@javax.annotation.Generated(value = "io.swagger.codegen.languages.JavaClientCodegen", date = "2019-05-20T15:12:25.985Z")
public class FormDataResponseResults {
  @SerializedName("data")
  private List<FormFieldData> data = null;

  @SerializedName("total")
  private Integer total = null;

  public FormDataResponseResults data(List<FormFieldData> data) {
    this.data = data;
    return this;
  }

  public FormDataResponseResults addDataItem(FormFieldData dataItem) {
    if (this.data == null) {
      this.data = new ArrayList<FormFieldData>();
    }
   ...
   /**
   * Depends on what is defined for the form
   * @return data
  **/
  @ApiModelProperty(value = "Depends on what is defined for the form")
  public List<FormFieldData> getData() {
    return data;
  }

  public void setData(List<FormFieldData> data) {
    this.data = data;
  }

  public FormDataResponseResults total(Integer total) {
    this.total = total;
    return this;
  }

   /**
   * Total number of submissions associated with the form.
   * @return total
  **/
  @ApiModelProperty(value = "Total number of submissions associated with the form.")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    FormDataResponseResults formDataResponseResults = (FormDataResponseResults) o;
    return Objects.equals(this.data, formDataResponseResults.data) &&
        Objects.equals(this.total, formDataResponseResults.total);
  }
  ...
  public String toString() {
    ...
    sb.append("class FormDataResponseResults {\n");
