...
import io.swagger.client.model.FormFieldUploadAreaSettings;
...
public class FormFieldUploadArea {
  @SerializedName("id")
  ...
  private FormFieldUploadAreaSettings settings = null;

  public FormFieldUploadArea id(Integer id) {
    this.id = id;
    return this;
  }
   ...
   * @return id
  **/
  @Schema(example = "1103", description = "ID of the form field. ")
  ...
  public FormFieldUploadArea name(String name) {
    this.name = name;
    return this;
  }
   ...
   * @return name
  **/
  @Schema(example = "Upload Area", description = "Label of the field (not used).")
  ...
  public FormFieldUploadArea order(Integer order) {
    this.order = order;
    return this;
  }
  ...
  **/
  ...
  public FormFieldUploadArea type(String type) {
    this.type = type;
    return this;
  }
   ...
   * @return type
  **/
  @Schema(description = "Type is upload_area.")
  ...
  public FormFieldUploadArea settings(FormFieldUploadAreaSettings settings) {
  ...
  **/
  @Schema(description = "")
  public FormFieldUploadAreaSettings getSettings() {
    return settings;
  }

  public void setSettings(FormFieldUploadAreaSettings settings) {
    this.settings = settings;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    FormFieldUploadArea formFieldUploadArea = (FormFieldUploadArea) o;
    return Objects.equals(this.id, formFieldUploadArea.id) &&
        Objects.equals(this.name, formFieldUploadArea.name) &&
        Objects.equals(this.order, formFieldUploadArea.order) &&
        Objects.equals(this.type, formFieldUploadArea.type) &&
        Objects.equals(this.settings, formFieldUploadArea.settings);
  }
  ...
  public String toString() {
    ...
    sb.append("class FormFieldUploadArea {\n");
