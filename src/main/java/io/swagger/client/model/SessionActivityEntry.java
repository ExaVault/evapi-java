...
import io.swagger.client.model.SessionActivityEntryAttributes;
import io.swagger.v3.oas.annotations.media.Schema;
import java.io.IOException;
/**
 * Single entry of session activity
 */
@Schema(description = "Single entry of session activity")
...
public class SessionActivityEntry {
  ...
  **/
  ...
  public SessionActivityEntry type(TypeEnum type) {
    this.type = type;
    return this;
  }
   ...
   * @return type
  **/
  @Schema(example = "sessionActivity", description = "")
  ...
  public SessionActivityEntry attributes(SessionActivityEntryAttributes attributes) {
  ...
  **/
  @Schema(description = "")
  public SessionActivityEntryAttributes getAttributes() {
    return attributes;
  }

  public void setAttributes(SessionActivityEntryAttributes attributes) {
    this.attributes = attributes;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    SessionActivityEntry sessionActivityEntry = (SessionActivityEntry) o;
    return Objects.equals(this.id, sessionActivityEntry.id) &&
        Objects.equals(this.type, sessionActivityEntry.type) &&
        Objects.equals(this.attributes, sessionActivityEntry.attributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class SessionActivityEntry {\n");
