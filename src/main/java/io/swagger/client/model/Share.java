...
public class Share {
  ...
  **/
  ...
  public Share nodes(List<Node> nodes) {
    this.nodes = nodes;
    return this;
  }

  public Share addNodesItem(Node nodesItem) {
    if (this.nodes == null) {
   ...
   * @return nodes
   **/
  @ApiModelProperty(value = "List of items included in the share")
  ...
  public Share assets(List<String> assets) {
    this.assets = assets;
    return this;
  }

  public Share addAssetsItem(String assetsItem) {
    if (this.assets == null) {
  ...
  /**
   * Name of included files
   * @return assets
   **/
  @ApiModelProperty(value = "Name of included files")
  ...
  **/
  ...
  public Share notification(Notification notification) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.id, share.id) &&
        ...
        Objects.equals(this.nodes, share.nodes) &&
        Objects.equals(this.assets, share.assets) &&
