...
import io.swagger.client.model.DeletedResource;
...
public class DeletedResourcesResponse {
  /**
   * Flag indicates API call status. &#x60;0&#x60; is failure; &#x60;1&#x60; is success; &#x60;2&#x60; means partial success - some but not all files were moved, copied or deleted.
   */
  ...
  private List<DeletedResource> results = null;

  public DeletedResourcesResponse success(SuccessEnum success) {
   ...
   * @return success
  **/
  @ApiModelProperty(example = "1", value = "Flag indicates API call status. `0` is failure; `1` is success; `2` means partial success - some but not all files were moved, copied or deleted.")
  ...
  public DeletedResourcesResponse error(Object error) {
    this.error = error;
    return this;
  }
  ...
  **/
  ...
  public DeletedResourcesResponse results(List<DeletedResource> results) {
    this.results = results;
    return this;
  }

  public DeletedResourcesResponse addResultsItem(DeletedResource resultsItem) {
    if (this.results == null) {
      this.results = new ArrayList<DeletedResource>();
    }
  ...
  **/
  ...
  public List<DeletedResource> getResults() {
    return results;
  }

  public void setResults(List<DeletedResource> results) {
    this.results = results;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    DeletedResourcesResponse deletedResourcesResponse = (DeletedResourcesResponse) o;
    return Objects.equals(this.success, deletedResourcesResponse.success) &&
        Objects.equals(this.error, deletedResourcesResponse.error) &&
        Objects.equals(this.results, deletedResourcesResponse.results);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeletedResourcesResponse {\n");
