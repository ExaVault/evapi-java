...
public class ShareRecipient {
   ...
   * @return id
  **/
  @ApiModelProperty(example = "2", value = "ID of the recipient.")
   ...
   * @return shareId
  **/
  @ApiModelProperty(example = "23", value = "ID of the share that the recipoient belongs to.")
   ...
   * @return type
  **/
  @ApiModelProperty(example = "owner", value = "Type of the recipient.")
   ...
   * @return hash
  **/
  @ApiModelProperty(example = "fseowxan", value = "Share hash.")
   ...
   * @return email
  **/
  @ApiModelProperty(example = "recipient@gmail.com", value = "Recipient email address.")
   ...
   * @return sent
  **/
  @ApiModelProperty(example = "true", value = "Set to true if invite email was sent; false otherwise.")
   ...
   * @return received
  **/
  @ApiModelProperty(example = "false", value = "Set to true if recipient has accessed the share. Note this is set to true when the recipient clicks the link to access the share; not when they download a file.")
  ...
  public ShareRecipient created(String created) {
   ...
   * @return created
  **/
  @ApiModelProperty(example = "2017-04-21 10:53:47", value = "Timestamp of adding recipient to the share.")
