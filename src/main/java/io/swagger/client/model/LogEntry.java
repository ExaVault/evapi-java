...
public class LogEntry {
  ...
  **/
  ...
  public LogEntry protocol(String protocol) {
   ...
   /**
   * Protocol used for the operation. Protocol can vary on type of application you or your users used to work with your account. Some of possible values are &#x60;web&#x60;, &#x60;https&#x60;, &#x60;sftp&#x60;, &#x60;ftp&#x60;, &#x60;ftps&#x60;. Access via API will show the name of the API key used.
   * @return protocol
  **/
  @ApiModelProperty(example = "web", value = "Protocol used for the operation. Protocol can vary on type of application you or your users used to work with your account. Some of possible values are `web`, `https`, `sftp`, `ftp`, `ftps`. Access via API will show the name of the API key used.")
