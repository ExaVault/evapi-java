...
public class CallbackLogEntry {
  ...
  public CallbackLogEntry id(Integer id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public CallbackLogEntry created(String created) {
  ...
  **/
  ...
  public CallbackLogEntry endpointUrl(String endpointUrl) {
    this.endpointUrl = endpointUrl;
    return this;
  }

   /**
   * URL that webhook update was POSTed to.
   * @return endpointUrl
  **/
  @ApiModelProperty(example = "http://example.com/webhook", value = "URL that webhook update was POSTed to.")
  ...
  public CallbackLogEntry event(Object event) {
    this.event = event;
    return this;
  }
   ...
   * @return event
  **/
  @ApiModelProperty(example = "Upload", value = "Action that triggered the webhook.")
  ...
  public CallbackLogEntry attempt(Integer attempt) {
    this.attempt = attempt;
    return this;
  }

   /**
   * Number of times the message has been sent (including this entry). Whenever the receiving endpoint does not return a 200 response, the system attempts again up to maxium of 8 attempts
   * @return attempt
  **/
  @ApiModelProperty(example = "2", value = "Number of times the message has been sent (including this entry). Whenever the receiving endpoint does not return a 200 response, the system attempts again up to maxium of 8 attempts")
  ...
  public CallbackLogEntry responseSize(Integer responseSize) {
    this.responseSize = responseSize;
    return this;
  }

   /**
   * Number of bytes returned in the body of the response from the endpoint
   * @return responseSize
  **/
  @ApiModelProperty(example = "2", value = "Number of bytes returned in the body of the response from the endpoint")
  ...
  public CallbackLogEntry response(String response) {
   ...
   * @return response
  **/
  @ApiModelProperty(example = "OK", value = "Body of the response.")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    CallbackLogEntry callbackLogEntry = (CallbackLogEntry) o;
    return Objects.equals(this.id, callbackLogEntry.id) &&
        Objects.equals(this.created, callbackLogEntry.created) &&
        Objects.equals(this.endpointUrl, callbackLogEntry.endpointUrl) &&
        Objects.equals(this.event, callbackLogEntry.event) &&
        Objects.equals(this.attempt, callbackLogEntry.attempt) &&
        Objects.equals(this.responseSize, callbackLogEntry.responseSize) &&
        Objects.equals(this.response, callbackLogEntry.response);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, created, endpointUrl, event, attempt, responseSize, response);
  }
  ...
  public String toString() {
    ...
    sb.append("class CallbackLogEntry {\n");
