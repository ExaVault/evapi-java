...
import io.swagger.client.model.NotificationMessage;
...
public class NotificationActivityResponse {
  ...
  private List<NotificationMessage> results = null;

  public NotificationActivityResponse success(SuccessEnum success) {
  ...
  **/
  ...
  public NotificationActivityResponse error(Object error) {
    this.error = error;
    return this;
  }
  ...
  **/
  ...
  public NotificationActivityResponse results(List<NotificationMessage> results) {
    this.results = results;
    return this;
  }

  public NotificationActivityResponse addResultsItem(NotificationMessage resultsItem) {
    if (this.results == null) {
      this.results = new ArrayList<NotificationMessage>();
    }
   ...
   /**
   * Array of NotificationMessage objects.
   * @return results
  **/
  @ApiModelProperty(value = "Array of NotificationMessage objects.")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    NotificationActivityResponse notificationActivityResponse = (NotificationActivityResponse) o;
    return Objects.equals(this.success, notificationActivityResponse.success) &&
        Objects.equals(this.error, notificationActivityResponse.error) &&
        Objects.equals(this.results, notificationActivityResponse.results);
  }
