...
public class CreateFolder {
  ...
  public CreateFolder accessToken(String accessToken) {
  ...
  **/
  ...
  public CreateFolder folderName(String folderName) {
   ...
   * @return folderName
  **/
  @ApiModelProperty(example = "awesome name", required = true, value = "Name of the folder to create.")
  ...
  public CreateFolder path(String path) {
   ...
   /**
   * Where to create the folder. Use **_/_** to create a folder in the user&#39;s home directory.
   * @return path
  **/
  @ApiModelProperty(example = "/nested", required = true, value = "Where to create the folder. Use **_/_** to create a folder in the user's home directory.")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.accessToken, createFolder.accessToken) &&
        Objects.equals(this.folderName, createFolder.folderName) &&
        Objects.equals(this.path, createFolder.path);
  }

  @Override
  public int hashCode() {
    return Objects.hash(accessToken, folderName, path);
  }
