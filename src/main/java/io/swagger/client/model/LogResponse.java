...
public class LogResponse {
  ...
  private List<LogEntry> results = null;

  public LogResponse success(SuccessEnum success) {
  ...
  **/
  ...
  public LogResponse error(Object error) {
    this.error = error;
    return this;
  }
  ...
  **/
  ...
  public LogResponse results(List<LogEntry> results) {
    this.results = results;
    return this;
  }

  public LogResponse addResultsItem(LogEntry resultsItem) {
    if (this.results == null) {
      this.results = new ArrayList<LogEntry>();
    }
   ...
   * @return results
  **/
  @ApiModelProperty(value = "Array of LogEntry objects.")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.success, logResponse.success) &&
        Objects.equals(this.error, logResponse.error) &&
        Objects.equals(this.results, logResponse.results);
  }
