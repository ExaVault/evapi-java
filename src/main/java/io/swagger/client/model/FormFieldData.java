 ...
 */
@ApiModel(description = "Contains the data submitted for a form.")
...
public class FormFieldData {
  ...
  @SerializedName("other fields")
  private Object otherFields = null;

  public FormFieldData created(String created) {
   ...
   * @return created
  **/
  @ApiModelProperty(example = "2019-01-03 10:23:21", value = "Timestamp of the submission")
  ...
  public FormFieldData paths(List<String> paths) {
    this.paths = paths;
    return this;
  }

  public FormFieldData addPathsItem(String pathsItem) {
    if (this.paths == null) {
   ...
   * @return paths
  **/
  @ApiModelProperty(value = "Full paths to files associated with the form submission")
  ...
  public FormFieldData otherFields(Object otherFields) {
    this.otherFields = otherFields;
    return this;
  }

   /**
   * All fields defined on the form will be included. Name will be the name of the field. Value is the value that was submitted in the form. Each will be its own attribute of the data object
   * @return otherFields
  **/
  @ApiModelProperty(value = "All fields defined on the form will be included. Name will be the name of the field. Value is the value that was submitted in the form. Each will be its own attribute of the data object")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    FormFieldData formFieldData = (FormFieldData) o;
    return Objects.equals(this.created, formFieldData.created) &&
        Objects.equals(this.paths, formFieldData.paths) &&
        Objects.equals(this.otherFields, formFieldData.otherFields);
  }

  @Override
  public int hashCode() {
    return Objects.hash(created, paths, otherFields);
  }
  ...
  public String toString() {
    ...
    sb.append("class FormFieldData {\n");
    
    sb.append("    created: ").append(toIndentedString(created)).append("\n");
    sb.append("    paths: ").append(toIndentedString(paths)).append("\n");
    sb.append("    otherFields: ").append(toIndentedString(otherFields)).append("\n");
    sb.append("}");
    return sb.toString();
  }
