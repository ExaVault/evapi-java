 ...
 */
@ApiModel(description = "Advanced field settings")
...
public class FormFieldSettings {
   ...
   * @return description
  **/
  @ApiModelProperty(value = "Secondary description of field")
   ...
   * @return width
  **/
  @ApiModelProperty(example = "0.5", value = "How much of the available width the field should occupy")
   ...
   * @return isRequired
  **/
  @ApiModelProperty(example = "false", value = "Whether this field must be completed before form can be submitted")
  ...
  **/
  @ApiModelProperty(example = "false", value = "Whether to place submitted files into a subfolder named the contents of this field. Only takes effect when the `fileDropCreateFolders` parameter on the receive folder is `true`. `isRequired` must be set to `true` if this setting is `true`.")
  ...
  @Override
  public int hashCode() {
    return Objects.hash(description, width, isRequired, useAsFolderName);
  }
