...
public class UsersList {
    ...
    public UsersList totalUsers(Integer totalUsers) {
     ...
     * @return totalUsers
     **/
    @ApiModelProperty(value = "Number of users in account")
    ...
    public UsersList users(List<User> users) {
        this.users = users;
        return this;
    }

    public UsersList addUsersItem(User usersItem) {
        if (this.users == null) {
    ...
    public boolean equals(java.lang.Object o) {
        ...
        return Objects.equals(this.totalUsers, usersList.totalUsers) &&
                Objects.equals(this.users, usersList.users);
    }

    @Override
    public int hashCode() {
        return Objects.hash(totalUsers, users);
    }
