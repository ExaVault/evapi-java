...
public class Error401Errors {
  ...
  public Error401Errors code(String code) {
    this.code = code;
    return this;
  }
   ...
   * @return code
  **/
  @Schema(example = "ERROR_INVALID_CREDENTIALS", required = true, description = "Error Code")
  ...
  public Error401Errors detail(String detail) {
    this.detail = detail;
    return this;
  }
   ...
   * @return detail
  **/
  @Schema(example = "HTTP_UNAUTHORIZED", required = true, description = "Additional Details")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    Error401Errors error401Errors = (Error401Errors) o;
    return Objects.equals(this.code, error401Errors.code) &&
        Objects.equals(this.detail, error401Errors.detail);
  }
