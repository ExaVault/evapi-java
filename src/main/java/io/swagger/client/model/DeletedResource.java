 ...
 */
@ApiModel(description = "Array of deleted resources.")
...
public class DeletedResource {
  ...
  public DeletedResource file(String file) {
    this.file = file;
    return this;
  }
   ...
   * @return file
  **/
  @ApiModelProperty(example = "example.txt", value = "Name of the resource.")
  ...
  public DeletedResource size(Long size) {
    this.size = size;
    return this;
  }
   ...
   * @return size
  **/
  @ApiModelProperty(example = "23241", value = "Size of the resource.")
  public Long getSize() {
    return size;
  }
  ...
  public DeletedResource success(SuccessEnum success) {
   ...
   * @return success
  **/
  @ApiModelProperty(example = "1", value = "Delete operation status.")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.file, deletedResource.file) &&
        Objects.equals(this.size, deletedResource.size) &&
        Objects.equals(this.success, deletedResource.success);
  }

  @Override
  public int hashCode() {
    return Objects.hash(file, size, success);
  }
