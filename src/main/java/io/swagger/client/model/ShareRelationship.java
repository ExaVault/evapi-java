...
public class ShareRelationship {
  ...
  public ShareRelationship id(Integer id) {
    this.id = id;
    return this;
  }
   ...
   * @return id
  **/
  @Schema(example = "22", description = "ID of the share.")
  ...
  public ShareRelationship type(TypeEnum type) {
    this.type = type;
    return this;
  }
   ...
   * @return type
  **/
  @Schema(example = "share", description = "Type of share. ")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    ShareRelationship shareRelationship = (ShareRelationship) o;
    return Objects.equals(this.id, shareRelationship.id) &&
        Objects.equals(this.type, shareRelationship.type);
  }
  ...
  public String toString() {
    ...
    sb.append("class ShareRelationship {\n");
