...
public class NotificationMessage {
  ...
  /**
   * Action which triggers the notification.
   */
  ...
  public NotificationMessage id(Integer id) {
    this.id = id;
    return this;
  }

   /**
   * ID of the notifications message.
   * @return id
  **/
  @ApiModelProperty(example = "74578952", value = "ID of the notifications message.")
  ...
  public NotificationMessage notificationSetting(Notification notificationSetting) {
    this.notificationSetting = notificationSetting;
    return this;
  }

   /**
   * Notification which triggered this message.
   * @return notificationSetting
  **/
  @ApiModelProperty(value = "Notification which triggered this message.")
   ...
   * @return message
  **/
  @ApiModelProperty(example = "User 'exavaultuser' has uploaded a file: '/examplefolder/examplefile.jpg' ", value = "Message body.")
  ...
  public NotificationMessage path(String path) {
    this.path = path;
    return this;
  }

   /**
   * Path to the resource the notification is set on.
   * @return path
  **/
  @ApiModelProperty(example = "/examplefolder/examplefile.jpg", value = "Path to the resource the notification is set on.")
  ...
  public NotificationMessage action(ActionEnum action) {
    this.action = action;
    return this;
  }
   ...
   * @return action
  **/
  @ApiModelProperty(example = "upload", value = "Action which triggers the notification.")
  ...
  public NotificationMessage username(String username) {
    this.username = username;
    return this;
  }

   /**
   * Name of the user that triggered the notification.
   * @return username
  **/
  @ApiModelProperty(example = "exavaultuser", value = "Name of the user that triggered the notification.")
  ...
  public NotificationMessage sent(Boolean sent) {
    this.sent = sent;
    return this;
  }

   /**
   * Flag set to true if a notification email was sent.
   * @return sent
  **/
  @ApiModelProperty(example = "true", value = "Flag set to true if a notification email was sent.")
  ...
  public NotificationMessage created(String created) {
    this.created = created;
    return this;
  }

   /**
   * Timestamp of notification message creation.
   * @return created
  **/
  @ApiModelProperty(example = "2017-04-25 18:00:32", value = "Timestamp of notification message creation.")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.id, notificationMessage.id) &&
        Objects.equals(this.notificationSetting, notificationMessage.notificationSetting) &&
        Objects.equals(this.message, notificationMessage.message) &&
        Objects.equals(this.path, notificationMessage.path) &&
        Objects.equals(this.action, notificationMessage.action) &&
        Objects.equals(this.username, notificationMessage.username) &&
        Objects.equals(this.sent, notificationMessage.sent) &&
        Objects.equals(this.created, notificationMessage.created);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, notificationSetting, message, path, action, username, sent, created);
  }
