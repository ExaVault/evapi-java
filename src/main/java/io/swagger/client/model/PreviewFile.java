 ...
 */
@ApiModel(description = "Object with preview image properties.")
...
public class PreviewFile {
  ...
  public PreviewFile image(String image) {
    this.image = image;
    return this;
  }
   ...
   * @return image
  **/
  @ApiModelProperty(example = "iVBORw0KGgoAAAANSUhEUgAAACIAAAAoCAYAAACb3CikAAAABGdBTUEAALGPC", value = "Binary image content, base64 encoded.")
  ...
  public PreviewFile size(Long size) {
    this.size = size;
    return this;
  }
   ...
   * @return size
  **/
  @ApiModelProperty(example = "2186", value = "Size of the image in bytes.")
  public Long getSize() {
    return size;
  }
  ...
  public PreviewFile imageId(String imageId) {
   ...
   * @return imageId
  **/
  @ApiModelProperty(example = "6afaa3ef4056dc602ccfc69ab52d6f40", value = "ID of the image.")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.image, previewFile.image) &&
        Objects.equals(this.size, previewFile.size) &&
        Objects.equals(this.imageId, previewFile.imageId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(image, size, imageId);
  }
