...
import io.swagger.client.model.ShareLogEntry;
...
public class ShareActivityResponse {
  ...
  private List<ShareLogEntry> results = null;

  public ShareActivityResponse success(SuccessEnum success) {
  ...
  **/
  ...
  public ShareActivityResponse error(Object error) {
    this.error = error;
    return this;
  }
  ...
  **/
  ...
  public ShareActivityResponse results(List<ShareLogEntry> results) {
    this.results = results;
    return this;
  }

  public ShareActivityResponse addResultsItem(ShareLogEntry resultsItem) {
    if (this.results == null) {
      this.results = new ArrayList<ShareLogEntry>();
    }
   ...
   /**
   * Array of ShareLogEntry objects.
   * @return results
  **/
  @ApiModelProperty(value = "Array of ShareLogEntry objects.")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    ShareActivityResponse shareActivityResponse = (ShareActivityResponse) o;
    return Objects.equals(this.success, shareActivityResponse.success) &&
        Objects.equals(this.error, shareActivityResponse.error) &&
        Objects.equals(this.results, shareActivityResponse.results);
  }
