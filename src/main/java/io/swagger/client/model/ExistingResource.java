...
public class ExistingResource {
  ...
  public ExistingResource exists(Boolean exists) {
    this.exists = exists;
    return this;
  }

   /**
   * Flag indicates whether the resource exist.
   * @return exists
  **/
  @ApiModelProperty(example = "true", value = "Flag indicates whether the resource exist.")
  ...
  public ExistingResource resource(ResourceProperty resource) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    ExistingResource existingResource = (ExistingResource) o;
    return Objects.equals(this.exists, existingResource.exists) &&
        Objects.equals(this.resource, existingResource.resource);
  }

  @Override
  public int hashCode() {
    return Objects.hash(exists, resource);
  }
