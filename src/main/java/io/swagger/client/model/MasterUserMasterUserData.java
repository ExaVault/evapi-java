...
public class MasterUserMasterUserData {
  /**
   * Gets or Sets type
   */
  ...
  public MasterUserMasterUserData type(TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  **/
  ...
  public MasterUserMasterUserData id(Integer id) {
    this.id = id;
    return this;
  }
   ...
   * @return id
  **/
  @Schema(description = "ID of master user for account")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    MasterUserMasterUserData masterUserMasterUserData = (MasterUserMasterUserData) o;
    return Objects.equals(this.type, masterUserMasterUserData.type) &&
        Objects.equals(this.id, masterUserMasterUserData.id);
  }
