...
public class AuthenticationApi {
     ...
     * @param username Name of the user to authenticate. (required)
     ...
     */
    public com.squareup.okhttp.Call authenticateUserCall(String apiKey, String username, String password, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    private com.squareup.okhttp.Call authenticateUserValidateBeforeCall(String apiKey, String username, String password, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        if (username == null) {
            throw new ApiException("Missing the required parameter 'username' when calling authenticateUser(Async)");
        }
        
        // verify the required parameter 'password' is set
        if (password == null) {
            throw new ApiException("Missing the required parameter 'password' when calling authenticateUser(Async)");
        }
        

        com.squareup.okhttp.Call call = authenticateUserCall(apiKey, username, password, progressListener, progressRequestListener);
        return call;
     ...
     */
    public AuthResponse authenticateUser(String apiKey, String username, String password) throws ApiException {
        ApiResponse<AuthResponse> resp = authenticateUserWithHttpInfo(apiKey, username, password);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<AuthResponse> authenticateUserWithHttpInfo(String apiKey, String username, String password) throws ApiException {
        com.squareup.okhttp.Call call = authenticateUserValidateBeforeCall(apiKey, username, password, null, null);
     ...
     */
    public com.squareup.okhttp.Call authenticateUserAsync(String apiKey, String username, String password, final ApiCallback<AuthResponse> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = authenticateUserValidateBeforeCall(apiKey, username, password, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<AuthResponse>(){}.getType();
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call logoutUserCall(String apiKey, String accessToken, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call logoutUserValidateBeforeCall(String apiKey, String accessToken, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        if (accessToken == null) {
            throw new ApiException("Missing the required parameter 'accessToken' when calling logoutUser(Async)");
        }
        

        com.squareup.okhttp.Call call = logoutUserCall(apiKey, accessToken, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public Response logoutUser(String apiKey, String accessToken) throws ApiException {
        ApiResponse<Response> resp = logoutUserWithHttpInfo(apiKey, accessToken);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<Response> logoutUserWithHttpInfo(String apiKey, String accessToken) throws ApiException {
        com.squareup.okhttp.Call call = logoutUserValidateBeforeCall(apiKey, accessToken, null, null);
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call logoutUserAsync(String apiKey, String accessToken, final ApiCallback<Response> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = logoutUserValidateBeforeCall(apiKey, accessToken, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<Response>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
