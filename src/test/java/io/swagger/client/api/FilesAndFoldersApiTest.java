...
import io.swagger.client.model.CopyResources;
import io.swagger.client.model.CreateFolder;
...
import io.swagger.client.model.MoveResources;
import io.swagger.client.model.PreviewFileResponse;
import io.swagger.client.model.RenameResources;
...
public class FilesAndFoldersApiTest {
    ...
    public void copyResourcesTest() throws ApiException {
        String apiKey = null;
        CopyResources copyResources = null;
        ModifiedResourcesResponse response = api.copyResources(apiKey, copyResources);
    ...
    public void createFolderTest() throws ApiException {
        ...
        Response response = api.createFolder(apiKey, createFolder);
    ...
    public void moveResourcesTest() throws ApiException {
        String apiKey = null;
        MoveResources moveResources = null;
        ModifiedResourcesResponse response = api.moveResources(apiKey, moveResources);
    ...
    public void renameResourceTest() throws ApiException {
        String apiKey = null;
        RenameResources renameResources = null;
        Response response = api.renameResource(apiKey, renameResources);
