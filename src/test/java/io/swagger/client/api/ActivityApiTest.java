...
public class ActivityApiTest {
     ...
     */
    @Test
    public void getCallbackLogsTest() throws ApiException {
        String apiKey = null;
        ...
        CallbackLogResponse response = api.getCallbackLogs(apiKey, accessToken, offset, sortBy, sortOrder, itemLimit);
     ...
     */
    @Test
    public void getFileActivityLogsTest() throws ApiException {
        String apiKey = null;
        String accessToken = null;
        Integer offset = null;
        String sortBy = null;
        ...
        String filter = null;
        Integer itemLimit = null;
        LogResponse response = api.getFileActivityLogs(apiKey, accessToken, offset, sortBy, sortOrder, filterBy, filter, itemLimit);
     ...
     */
    @Test
    public void getNotificationActivityTest() throws ApiException {
        String apiKey = null;
        String accessToken = null;
        NotificationActivityResponse response = api.getNotificationActivity(apiKey, accessToken);
     ...
     */
    @Test
    public void getShareActivityTest() throws ApiException {
        String apiKey = null;
        String accessToken = null;
        Integer id = null;
        ShareActivityResponse response = api.getShareActivity(apiKey, accessToken, id);
