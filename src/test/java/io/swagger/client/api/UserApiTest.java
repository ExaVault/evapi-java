...
public class UserApiTest {
    ...
    public void createUserTest() throws ApiException {
        ...
        Boolean locked = null;
        Boolean welcomeEmail = null;
        Boolean onboarding = null;
        Response response = api.createUser(apiKey, accessToken, username, destinationFolder, email, password, role, permissions, timeZone, nickname, expiration, locked, welcomeEmail, onboarding);
     ...
     */
    @Test
    public void resendWelcomeEmailTest() throws ApiException {
        String apiKey = null;
        String accessToken = null;
        String username = null;
        ResendWelcomeEmailResponse response = api.resendWelcomeEmail(apiKey, accessToken, username);
    ...
    public void updateUserTest() throws ApiException {
        ...
        String expiration = null;
        Boolean locked = null;
        Response response = api.updateUser(apiKey, accessToken, userId, username, nickname, destinationFolder, email, password, role, permissions, onboarding, timeZone, expiration, locked);
