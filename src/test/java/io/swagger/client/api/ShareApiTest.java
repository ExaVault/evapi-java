...
public class ShareApiTest {
    ...
    public void createShareTest() throws ApiException {
        String apiKey = null;
        CreateShare createShare = null;
        ShareResponse response = api.createShare(apiKey, createShare);
    ...
    public void updateShareTest() throws ApiException {
        String apiKey = null;
        UpdateShare updateShare = null;
        Response response = api.updateShare(apiKey, updateShare);
