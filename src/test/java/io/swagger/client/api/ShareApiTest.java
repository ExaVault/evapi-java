...
public class ShareApiTest {
     ...
     */
    @Test
    public void addFormDataTest() throws ApiException {
        String apiKey = null;
        String accessToken = null;
        Integer formId = null;
        String data = null;
        List<String> paths = null;
        Response response = api.addFormData(apiKey, accessToken, formId, data, paths);
     ...
     */
    @Test
    public void createShareTest() throws ApiException {
        String apiKey = null;
        String accessToken = null;
        String type = null;
        String name = null;
        ...
        ShareResponse response = api.createShare(apiKey, accessToken, type, name, filePaths, accessMode, subject, message, emails, ccEmail, requireEmail, embed, isPublic, password, expiration, hasNotification, notificationEmails, fileDropCreateFolders);
    ...
    public void deleteShareTest() throws ApiException {
        ...
        String accessToken = null;
        Integer id = null;
        Response response = api.deleteShare(apiKey, accessToken, id);
    ...
    public void getFormTest() throws ApiException {
        ...
        FormResponse response = api.getForm(apiKey, accessToken, formId, shareId);
    ...
    public void getFormDataTest() throws ApiException {
        ...
        Integer offset = null;
        Integer limit = null;
        FormDataResponse response = api.getFormData(apiKey, accessToken, formId, shareId, offset, limit);
    ...
    public void getShareTest() throws ApiException {
        ...
        String accessToken = null;
        Integer id = null;
        ShareResponse response = api.getShare(apiKey, accessToken, id);
    ...
    public void getSharesTest() throws ApiException {
        ...
        Integer offset = null;
        Integer limit = null;
        SharesResponse response = api.getShares(apiKey, accessToken, sortBy, sortOrder, type, filter, include, offset, limit);
    ...
    public void updateFormTest() throws ApiException {
        ...
        Response1 response = api.updateForm(apiKey, updateForm);
     ...
     */
    @Test
    public void updateShareTest() throws ApiException {
        String apiKey = null;
        String accessToken = null;
        Integer id = null;
        String name = null;
